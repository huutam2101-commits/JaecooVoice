        ...
        fun clickByBounds(bounds: Rect): Boolean {
            ...
            service.dispatchGesture(gesture, object : GestureResultCallback() {
                override fun onCompleted(gestureDescription: GestureDescription?) {
                    ...
                    Log.d(TAG, "clickByBounds gesture completed at $bounds")
                    success = true
                }

                override fun onCancelled(gestureDescription: GestureDescription?) {
                    super.onCancelled(gestureDescription)
                    Log.w(TAG, "clickByBounds gesture cancelled at $bounds")
                }
            }, null)
            return success
        }
        ...
        fun launchApp(packageName: String): Boolean {
            ...
            return try {
                ...
                if (intent != null) {
                    ...
                    Log.d(TAG, "launchApp SUCCESS: $packageName")
                    true
                } else {
                    Log.w(TAG, "launchApp FAILED: App not found -> $packageName")
                    false
                }
            } catch (e: Exception) {
